...
local PLAYER_LINE = {
	Init = function( self )
		...
		self.aTags = self:Add( "DLabel" )
		self.aTags:Dock( RIGHT )
		self.aTags:SetWidth( 50 )
		self.aTags:SetFont( "ScoreboardDefault" )
		self.aTags:SetTextColor( Color( 93, 93, 93 ) )
		self.aTags:SetContentAlignment( 5 )
		self.aTags:DockMargin( 0, 0, 10, 0 )
	...
	Think = function( self )
		...
		if ( self.aTagsName == nil || self.aTagsName != name || self.aTagsColor != color ) then
			self.aTagsName = name
			self.aTagsColor = color
			self.aTags:SetText( self.aTagsName )
			self.aTags:SetTextColor( self.aTagsColor )
			self.aTags:SizeToContentsX()
		end
